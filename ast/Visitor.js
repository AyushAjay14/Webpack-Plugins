...
class Visitor {
    ...
    getFunctions(){
        return this.alltopOrderFunctions;
    }
    getVariables(){
    ...
    visitVariableDeclarator(n) {
        ...
        this.allVariables[n.id.value] = {};
        this.currentVariableName = n.id.value;
    ...
    visitExpression(n) {
        this.allVariables[this.currentVariableName] = {type: n.type}
        switch (n.type) {
